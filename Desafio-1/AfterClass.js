...
let responseFind = personajes.find((element) => (element.name = "Rick Sanchez"));
console.log(responseFind);

// Ejercicio Clase complementario 
...
class Contador{
    ...
    constructor (responsable){
        ...
        this.cuenta = 0;
        this.totalContado = 0;
        obtenerCuentaGlobal = obtenerCuentaGlobal + this.totalContado;
    }
